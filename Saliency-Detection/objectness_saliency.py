...
ap.add_argument("-n", "--max-detections", type=int, default = 10, help = "maximum no.of detections to examine")
args = vars(ap.parse_args())

# load the input image
image = cv2.imread(args["image"])

# initialise OpenCV's objectness saliency detector and set the path to the 
# input model files
