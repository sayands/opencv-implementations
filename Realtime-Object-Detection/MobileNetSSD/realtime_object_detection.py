...
# initialise the video stream, allow the camera sensor to warm up
...
while True:
    # grab the frame from the threshold video stream and resize it to have a maximum width of
    # 400 pixels
    frame = vs.read()
...
print("[INFO] approx FPS time: {:.2f}".format(fps.fps()))
